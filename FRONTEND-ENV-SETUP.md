...
```env
NEXT_PUBLIC_API_BASE_URL=http://<YOUR_SRS_BACKEND_SERVER_IP>:3001
NEXT_PUBLIC_BACKEND_URL=http://<YOUR_SRS_BACKEND_SERVER_IP>:3001
```

### SRS Server Configuration

```env
NEXT_PUBLIC_SRS_API_URL=http://<YOUR_SRS_SERVER_IP>:1985
NEXT_PUBLIC_SRS_WEBRTC_URL=http://<YOUR_SRS_SERVER_IP>:8000
NEXT_PUBLIC_SRS_HTTP_URL=http://<YOUR_SRS_SERVER_IP>:8080
```
