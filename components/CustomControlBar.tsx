...
export function CustomControlBar() {
	...
	return (
		<div className='flex items-center justify-between p-4 bg-card border rounded-lg shadow-sm'>
			...
			<div className='flex items-center gap-2'>
				{/* Camera controls with device selector */}
				...
				{/* Microphone controls with device selector */}
				<div className='flex items-center'>
					<Button
						onClick={toggleAudio}
				...
				{/* Screen share button */}
				<Button onClick={handleScreenShare} variant='outline' size='sm'>
						...
						<div className='grid gap-4'>
							<div className='space-y-2'>
								...
								<p className='text-sm text-muted-foreground'>
									Configure screen sharing quality settings.
								</p>
							</div>
							<div className='grid gap-4'>
								{/* Resolution and FPS in the same container but separate controls */}
								...
								{isScreenSharing && (
									<div className='text-sm text-muted-foreground'>
										Settings cannot be changed while screen sharing is active.
									</div>
								)}
							</div>
						</div>
